  ...
  tryCatch({
    ...
    if(! nr.exporters.incl %in% c("ALL","SELECTED","UNSELECTED")){
      ...
      if(nr.exporters.incl=="ALL"){
        ...
        # counts the number of exporters affected by an intervention!
    ...
    # simply split the strings into long format!    
    ...
    ### why do we only take the values that are also conained in this database ? 
