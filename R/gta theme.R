...
gta_theme <- function(base.size=11,
  ...
  theme(line = element_line(colour = "#FFFFFF", size= 0.5, linetype = 1, lineend = "square"),
        ...
        axis.line = element_line(colour= gta_colour$grey[1], linetype = 1, size=0.2),
        ...
        panel.background = element_rect(fill=gta_colour$panel.bg, colour=gta_colour$grey[1], size=0.5, linetype=1),
        ...
        strip.background = element_rect(fill="#e5e5e5", colour=gta_colour$grey[1], size=0.5, linetype=1),
