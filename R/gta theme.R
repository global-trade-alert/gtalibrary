...
gta_theme <- function(base.size=12,
  ...
  theme(line = element_line(colour = "#FFFFFF", size = 2, linetype = 1, lineend = "square"),
        ...
        axis.ticks = element_line(colour=gta_colour_palette$grey[1], size=0.2),
        ...
        strip.background = element_rect(fill="#FFFFFF", colour=gta_colour_palette$grey[1], size=0.5, linetype=1),
